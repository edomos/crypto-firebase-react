...
import { FaGit, FaThermometerQuarter } from "react-icons/fa";
        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              ...
              <div className="flex justify-center md:justify-end py-4 md:py-0 md:p-4 mt-[-1rem]">
                <ThemeToggle />
              </div>
                ...
                <form>
                  <input  
                   ...
                   placeholder="Enter your email" 
                    />
                  <button className="bg-button text-btnText px-4 p-2 w-[300px] rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2">
                      Sign up
                    </button>
                </form>
              </div>
